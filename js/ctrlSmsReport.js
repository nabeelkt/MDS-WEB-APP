...
app.controller('ctrlSMSReport', function($scope, $filter, $http, $window, $interval) {
    ...
    scope.LoadSMSReport = function() {

        $.ajax({
            type: 'get',
            url: 'GService.asmx/fn_GetAutoSMSReport',
            data: {
